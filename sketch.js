...
body {
    ...
    overflow: auto;  /* ← sta scrollen toe als nodig */
    padding-top: 100px;  /* ← ruimte voor navigatie */
}
canvas {
    display: block;
    position: relative;
...
.nav {
    ...
    max-width: 90%;
    border-radius: 14px;
    z-index: 1000;  /* ← hoge z-index zodat deze altijd bovenop blijft */
}
.nav a {
    color: white;
...
createNavigation();  // ← Deze regel moet BUITEN de functie staan!

/* =====================================
   GRID & LAYOUT INSTELLINGEN
===================================== */

const NAV_OFFSET = 300;   // ← totale hoogte navigatie + marge
...
const TITLE_SPACE = 130;      // ← meer ruimte onder knoppen
...
const BUTTON_Y = NAV_OFFSET + 65;    // ← Aanpassen: hoger getal = lager op scherm
...
const TITLE_Y = NAV_OFFSET + 130;   // titel hoger/lager
...
const SUBTITLE_Y = NAV_OFFSET + 165;   // subtitle afstand

// DRAAK ACHTERGROND INSTELLINGEN - HIER KUN JE AANPASSEN!
const DRAGON_SCALE_X = 0.7;    // ← Horizontale schaal: 1.0=normaal, 1.5=breder, 0.5=smaller
const DRAGON_SCALE_Y = 0.5;    // ← Verticale schaal: 1.0=normaal, 1.5=hoger, 0.5=korter
