...
const DRAGON_Y_OFFSET = -100;     // ← Verticaal: negatief=omhoog, positief=omlaag (bijv. -50 of 100)
...
function showScoreFeedback() {
    ...
    if (correctCount === 0) {
        ...
        feedbackText = 'Fantastisch! Je hebt ze bijna allemaal goed. Nog even opletten bij de laatste paar en dan roep je de draak op!';
