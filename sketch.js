...
body {
    ...
    /* VERWIJDER alle touch-action en user-select hier */
}
canvas {
    display: block;
    position: relative;
    z-index: 1;
    touch-action: pan-y pinch-zoom;  /* ← AANGEPAST: sta zoom toe maar blokkeer horizontale scroll */
}
button {
    font-family: Arial, sans-serif;
...
function setup() {
    ...
    // Op mobiel: schaal canvas naar scherm breedte
    if (windowWidth < canvasWidth + 40) {
        let scaleRatio = (windowWidth - 40) / canvasWidth;  // ← HERNOEMD naar scaleRatio
